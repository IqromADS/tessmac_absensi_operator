                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                                color: Color(0xffB7B7B7), width: 2.w),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        controller
                                                .selectedPlate.value.isNotEmpty
                            ...
                            Obx(() => Row(
                                  children: [
                                    Transform.scale(
                                      scale: 1.h,
                                      child: Checkbox(
                                        value: controller.isRedSelected.value,
                                        onChanged: (value) {
                                          controller.updateCondition(
                                              'Red', value!);
                                        },
                                        activeColor: const Color(0xff0066D8),
                                      ),
                                    ),
                                    Text(
                                      "Red",
                            ...
                            Obx(() => Row(
                                  children: [
                                    Transform.scale(
                                      ...
                                      child: Checkbox(
                                        value:
                                            controller.isYellowSelected.value,
                                        onChanged: (value) {
                                          controller.updateCondition(
                                              'Yellow', value!);
                                        },
                            ...
                            Obx(() => Row(
                                  children: [
                                    Transform.scale(
                                      scale: 1.h,
                                      child: Checkbox(
                                        value: controller.isGreenSelected.value,
                                        onChanged: (value) {
                                          controller.updateCondition(
                                              'Green', value!);
                                        },
